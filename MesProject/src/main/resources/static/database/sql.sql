...
DROP TABLE IF EXISTS INDICA_DTL;
...
DROP TABLE IF EXISTS PROG_PRCS;
...
DROP TABLE IF EXISTS PRCS_FLOW;
...
DROP TABLE IF EXISTS RSC_STC_HIST;
...
DROP TABLE IF EXISTS RSC_STC_CLS;
...
CREATE TABLE EDCTS (
	...
	UNIT	VARCHAR2(30)	NULL,
	SAF_STC	NUMBER	NULL,
	CUTD_WRHOUS	VARCHAR(20)	NULL,
	WRHOUS_CD	VARCHAR2(6)	NOT NULL
);

DROP TABLE IF EXISTS PRDT_INSP;
...
DROP TABLE IF EXISTS PRDT_INSP_INFER;
...
DROP TABLE IF EXISTS RSC_ORDR_DTL;
...
DROP TABLE IF EXISTS PROG_PRCS_DTL;
...
DROP TABLE IF EXISTS PROG_PRCS_INFER;
...
DROP TABLE IF EXISTS RSC_INSP_DTL;
...
DROP TABLE IF EXISTS EDCTS_OUST;
...
DROP TABLE IF EXISTS EDCTS_IST;
...
DROP TABLE IF EXISTS EDCTS_STC;
...
DROP TABLE IF EXISTS RSC_OUST_DTL;
