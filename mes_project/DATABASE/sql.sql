...
ALTER TABLE Untitled ADD CONSTRAINT FK_RSC_OUST_TO_Untitled_1 FOREIGN KEY (
	RSC_OUST_NO
)
REFERENCES RSC_OUST (
	RSC_OUST_NO
...
ALTER TABLE Untitled ADD CONSTRAINT FK_RSC_TO_Untitled_1 FOREIGN KEY (
	RSC_CD
)
REFERENCES RSC (
	RSC_CD
