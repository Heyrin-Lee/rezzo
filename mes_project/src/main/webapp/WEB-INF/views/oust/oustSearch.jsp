...
<body>
   ...
   <div class="container-fluid px-4">
      ...
      <ol class="breadcrumb mb-4">
         <li class="breadcrumb-item active">출고조회</li>
      </ol>
   </div>
   <!-- 헤더부분 -->
     <section>
               ...
               <div class="card mb-4">
                  ...
                  <div class="card-body">
                     ...
                     <form>
                        ...
                        <div class="mb-3">
                           <label for="all">출고일자</label> 
                            <input type="date" id="frDate" name="frDate" style="width: 200px">~<input type="date" id="toDate" name="toDate" style="width: 200px">
                        </div>
                        <div class="mb-3">
                           <label for="name">거래처</label> <input
                              type="text" id="nmae" name="name">
                        	<input type="button" class="c_btn" data-bs-toggle="modal" data-bs-target="#comModal" value="검색"></input>
                        </div>
     					<div class="linelist">
